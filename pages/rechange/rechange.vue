		...
		<uni-popup :show="popupType === 'bottom-share'" position="bottom" @hidePopup="togglePopup('')">
			...
			<view class="bottom-content">
				<scroll-view :scroll-top="scrollTop" scroll-y="true" class="scroll-Y" @scrolltoupper="upper" @scrolltolower="lower" @scroll="scroll">
					<view
						...
						:key="index"
						class="bottom-content-box scroll-view-item_H"
						v-on:click="addClass(index)"
						v-bind:class="{ battery_type_ischeck: index == batteryTypecurrent }"
					>
						<button
							class="battery_type_default"
							v-bind:class="{ battery_type_ischeck: index == batteryTypecurrent }"
							@click="selectBattery(item.name, item.price_policy)"
						>
							{{ item.name }}
						</button>
					</view>
			...
			<view>
				<scroll-view
					...
					scroll-y="true"
					class="scroll-Y how_to_know_battery_type"
					@scrolltoupper="upper"
					@scrolltolower="lower"
					@scroll="scroll"
					v-show="isShowHowtoKnowBatteryType"
				>
